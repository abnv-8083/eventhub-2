...
import * as userEventService from '../../services/users/userEvent.service.js';
...
export const getUserProfile = async (req, res, next) => {
    try {
        const data = await userDashboardService.getDashboardData(req.session.user._id);
        const userWithPassword = await import('../../models/users/user.model.js').then(m => m.default.findById(req.session.user._id).select('+password'));
...
export const updateUserAvatar = async (req, res, next) => {
    try {
        ...
        const result = await userServices.updateUserAvatar(req.session.user._id, filePath);
