...
import { eventValidationSchema, draftEventValidationSchema } from '../../validations/organizer/event.validation.js';
import * as organizerEventService from '../../services/organizers/organizerEvent.service.js';
import * as organizerCouponService from '../../services/organizers/organizerCoupon.service.js';
import Event from '../../models/events/event.model.js';
import Booking from '../../models/payments/booking.model.js';
import Coupon from '../../models/payments/coupon.model.js';
...
export const updateEvent = async (req, res, next) => {
    try {
        ...
        const { updateEventValidationSchema, draftEventValidationSchema } = await import('../../validations/organizer/event.validation.js');
