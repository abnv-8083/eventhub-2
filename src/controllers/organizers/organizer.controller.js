...
import * as organizerService from '../../services/organizers/organizer.service.js';
import * as userServices from '../../services/users/user.service.js';
import * as userDashboardService from '../../services/users/userDashboard.service.js';
...
export const getProfile = async (req, res, next) => {
    try {
        const userWithPassword = await import('../../models/users/user.model.js').then(m => m.default.findById(req.session.organizer._id).select('+password'));
...
export const updateAvatar = async (req, res, next) => {
    try {
        ...
        const result = await userServices.updateUserAvatar(req.session.organizer._id, filePath);
