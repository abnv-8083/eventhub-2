...
import * as referralController from '../../controllers/users/referralController.js'
const userRouter = Router()
import { isUserAuthenticated, isBlocked, isUserLogged } from "../../middlewares/authMiddleware.js";
import { upload } from "../../config/cloudinary.js";
import { validateUpdateProfile, validatePasswordUpdate } from "../../middlewares/validate.js";
